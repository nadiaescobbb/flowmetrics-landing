 ...
 * SEO: Important for internal linking, sitemap structure
 * Design: Organized navigation, social links, legal
        ...
        <div className="py-12 md:py-16">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
            ...
            <div className="col-span-2">
              ...
              <p className="text-gray-600 mb-6 max-w-xs">
                Real-time analytics for growing businesses. Make better decisions with simple, powerful insights.
              </p>
          ...
          <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} FlowMetrics. All rights reserved.
            </p>
